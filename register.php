...
<body>
    ...
    <body>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $role = $_POST["role"];
            $phone = $_POST["phone"];
            $sql = "INSERT INTO users ( username, password, role, email,  phone_number) VALUES('$username','$password','$role','$email', '$phone')";
            //Bước 3: Thực thi truy vấn
            $result = mysqli_query($conn, $sql);
            //Bước 4: Xử lý kết quả truy vấn
            if ($result) {
                echo "<script>alert('Register in successfully !');</script>";
            } else {
                echo " Thêm thất bại";
            }
        }
